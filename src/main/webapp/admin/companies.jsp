            ...
            <div class="my-dashboard-content mt-3">
                <div class="row">
                	<% 
			        	...
			        	Iterator<VehicleCompany> itr = list.iterator();
			        	while(itr.hasNext()){
			        		VehicleCompany vc = itr.next();
			        		
			        		%>
					        <div class="col-md-4">
		                        <!-- whole card is given as a link, so give href in the below anchor tag -->
		                        <a href="models.jsp?cid=<%= vc.getVehicleCompanyId() %>" class="my-dashboard-box-link">
		                            <div class="my-dashboard-box">
		                                <div class="my-dashboard-box-header">
		                                    <h6><%= vc.getVehicleCompanyName() %> <i class="fa fa-car"></i></h6>
		                                </div>
		                                <div class="my-dashboard-box-content">
		                                    <div class="row">
		                                        <div class="col-md-12">View models of <%= vc.getVehicleCompanyName() %></div>                                        
		                                    </div>
		                                </div>
		                            </div>
		                        </a>
