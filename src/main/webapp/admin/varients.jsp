    ...
    <div style="margin-left:20%">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="models.jsp">Models</a></li>
      			 <li class="breadcrumb-item" aria-current="page">Varients</li>
            </ol>
        </nav>    
        
        <form action="../AddVarient" method="post" class="my-form">
            <div class="my-form-heading">
                <h5>Add New Varient</h5>
            </div>
            <div class="container-95">                
                <div class="row my-form-row">
                    <h6>Enter New Varient</h6>
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="model_varient_name">Varient</label>                                    
                            </div>
                            <div class="col-md-8">
                                <input type="text" name="model_varient_name" id="model_varient_name">
        ...
        <div class="my-dashboard">
            ...
            <div class="my-dashboard-content mt-3">
                <div class="row">
                	<% 
			        	List<VehicleModelVarient> list = VehicleModelVarientDao.getVarientsByModelId(request.getParameter("mid"));
			        	Iterator<VehicleModelVarient> itr = list.iterator();
			        	while(itr.hasNext()){
