				...
				<tr>
					<%
						...
						while (itr3.hasNext()) {
							...
							int service_id = js.getServiceId();
					...
					<td align="right"><%=total_service_price%></td>
				</tr>
				...
				<tr>
					<%
						...
						while (itr4.hasNext()) {
							...
							int lubricant_quantity = vld.getLubricantQuantity();
					...
					<td align="right"><%=total_lubricant_price%></td>
				</tr>
