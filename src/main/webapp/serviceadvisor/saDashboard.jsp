                            ...
                            <div class="my-dashboard-box">
                                ...
                                <div class="my-dashboard-box-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2"><%=JobcardInfoDao.getTotal(officer_username,"pending") %></div>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="my-dashboard-box">
                                ...
                                <div class="my-dashboard-box-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2"><%=JobcardInfoDao.getTotal(officer_username,"repaired") %></div>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="my-dashboard-box">
                                ...
                                <div class="my-dashboard-box-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2"><%=JobcardInfoDao.getTotal(officer_username,"completed") %></div>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="my-dashboard-box">
                                ...
                                <div class="my-dashboard-box-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2"><%=JobcardInfoDao.getTotal(officer_username,"arrived") %></div>
                                    </div>
                                </div>
                            </div>
                        </a>
