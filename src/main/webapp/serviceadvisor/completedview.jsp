...
<body>
	<%
OfficerInfo oi = OfficerInfoDao.getAllByRole("final_inspector");
	...
	<div class="container-95">
		<div class="my-form" id="verify-static-details">
			...
			<div class="row my-form-row">
				<div class="col-md-6">
					<table
						class="table table-striped table-bordered customer-verification-info-table">
						<tbody>
							<tr>
...
%>
				...
				<div class="col-md-6">
					<label for="ddate" style="margin-left: 8px;"><b>Delivery
							Date:<%= ji.getDeliveryDate() %></label><br> <label for="toalamount"
						style="margin-left: 8px;"><b>Total Amount:</label>
				</div>


				<label for="dtime" style="margin-left: 8px;"><b>Delivery
						Time: <%= ji.getDeliveryTime() %></label>
			</div>
